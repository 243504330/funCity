Page({
    ...
    wx.getStorage({
      ...
      success(res) {
        ...
        var total = parseInt((count * orderamt) * 10) / 10
         ...
         wx.request({
           url: pub_url + '/toysburg/BuyTicket/createTicketOrder',
           method: 'GET',
           data: data,
           header: {
          ...
          success(res) {
            ...
            if (res.data.retCode == '000') {
              wx.requestPayment({
                ...
                success(res) {
                  wx.redirectTo({
                    url: '../buy-success/buy-success?type=game',
                  })
                },
                fail(res) {
                  console.log(res)
  ...
  jdShow:function(){
    ...
    var balance = this.data.list.ext.balance;
  ...
  load: function (ticketid){
    ...
    var url = pub_url + '/toysburg/ticket/buyPackageTicket'
    wx.getStorage({
      key: 'user_data',
      success(res) {
        var json = JSON.parse(res.data);
