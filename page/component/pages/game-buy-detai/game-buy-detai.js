Page({
  ...
  jdShow:function(){
    ...
    var balance = this.data.item.userGold;
  ...
  chongzhi: function () {
    ...
    wx.getStorage({
      ...
      success(res) {
        ...
        wx.request({
          url: pub_url + '/toysburg/BuyGameCoin/gameCoinOrder',
          method: 'GET',
          data: data,
          header: {
            'content-type': 'application/json' // 默认值
  ...
  jdPay:function(){
    ...
    wx.request({
      url: pub_url + '/toysburg/game/goldPay',
      method: 'GET',
      data: {
        terminal: 'android',
        userid: userid,
  ...
  load: function (type,ticketid){
    ...
    var url = pub_url + '/toysburg/game/queryBuyDetail'
    wx.getStorage({
      key: 'user_data',
      success(res) {
        var json = JSON.parse(res.data);
